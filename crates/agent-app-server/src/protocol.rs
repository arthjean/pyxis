...
pub struct TurnCompletedNotification {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cause_category: Option<FailureCategory>,
    /// Next diagnostic step for that category, identical to the sentence the
    /// other surfaces show.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cause_guidance: Option<String>,
}
...
impl From<agent_runtime::FailureCategory> for FailureCategory {
    fn from(category: agent_runtime::FailureCategory) -> Self {
        match category {
            agent_runtime::FailureCategory::Provider => Self::Provider,
            agent_runtime::FailureCategory::Auth => Self::Auth,
            agent_runtime::FailureCategory::Context => Self::Context,
            agent_runtime::FailureCategory::InvalidRequest => Self::InvalidRequest,
            agent_runtime::FailureCategory::ModelRuntime => Self::ModelRuntime,
            agent_runtime::FailureCategory::Guardrail => Self::Guardrail,
            agent_runtime::FailureCategory::Interrupted => Self::Interrupted,
            agent_runtime::FailureCategory::Store => Self::Store,
            agent_runtime::FailureCategory::Unknown => Self::Unknown,
        }
    }
}
