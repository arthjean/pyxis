...
fingerprinted, never hand-edited. The same holds for the three catalogs,
[`docs/crate-graph.md`](docs/crate-graph.md),
[`docs/tool-catalog.md`](docs/tool-catalog.md) and
[`docs/config-catalog.md`](docs/config-catalog.md): each is rendered from the
code, compared byte for byte inside `just test`, and regenerated by the command
its own first two lines name. Editing one by hand loses the edit at the next
regeneration; the fix goes into the source the catalog reads.
...
| Tool catalog: the twenty-nine registered tools and their policy properties, taint included, generated | [`docs/tool-catalog.md`](docs/tool-catalog.md) |
| Configuration catalog: the fifteen keys, their layer, flag, variable and security character, generated | [`docs/config-catalog.md`](docs/config-catalog.md) |
